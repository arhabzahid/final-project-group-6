  ...
  <div class="auth-page">
    ...
    <div class="brand-panel">
      <div class="brand-content">
        ...
        <h1>MedPortal</h1>
        <p>Join thousands of patients and providers on a platform built for modern healthcare.</p>
        <ul class="brand-features">
          <li>Book appointments online</li>
          <li>Message your care team directly</li>
...
.role-btn:first-child {
  border-right: 1.5px solid #c4d9ee;
}
